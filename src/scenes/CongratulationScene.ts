export default class CongratulationScene extends Phaser.Scene {

    constructor () {
        super('congratulation-scene');
    }
    ...
    create () {
        ...
        this.add.text(260, height / 2 - 100, 'CONGRATULATION', { fontSize: '64px', fill: '#fff' });
